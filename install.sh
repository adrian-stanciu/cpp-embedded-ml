...
unzip -j mobilenet_v1_1.0_224_quant_and_labels.zip labels_mobilenet_quant_v1_224.txt -d models
unzip -j mobilenet_v1_1.0_224_quant_and_labels.zip mobilenet_v1_1.0_224_quant.tflite -d models
