...
unzip -j mobilenet_v1_1.0_224_quant_and_labels.zip models/labels_mobilenet_quant_v1_224.txt
unzip -j mobilenet_v1_1.0_224_quant_and_labels.zip models/mobilenet_v1_1.0_224_quant.tflite
